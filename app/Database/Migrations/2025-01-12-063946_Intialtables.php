...
class Initialtables extends Migration
{
    ...
    public function down()
    {
        ...
        // $this->forge->dropTable('user_stages');
        // $this->forge->dropTable('appointment_lecturers');
        ...
        foreach ($tables as $table) {
            if ($table != 'migrations') $db->query("DROP TABLE IF EXISTS `$table`");
        }
        $db->query('SET FOREIGN_KEY_CHECKS = 1;');
    }
}
